...
function get_arr() {
    ...
    banner: [
      {
        ...
        operation: { submit_assessment: "提交评估", benchmark: "benchmark" },
      },
    ],
    menu: [
        { word: "1· Introduction", id: "to_intro", classes: "menu-1 to_btn" },
        { word: "2· Summary", id: "to_category", classes: "menu-1 to_btn" },
        {
            word: "3· Class Definitions",
            id: "to_define",
            classes: "menu-1 to_btn",
        },
        { word: "4· Data Example", id: "to_general", classes: "menu-1 to_btn" },
        { word: "5· Dataset Download", id: "to_down", classes: "menu-1 to_btn" },
        {
        ...
        { word: "8· submission", id: "to_submission", classes: "menu-1 to_btn" },
        { word: "9· Publication", id: "to_public", classes: "menu-1 to_btn" },
        ],
        content: [
        {
            type: "p",
        ...
        { type: "p", attr: 'class="title-2 mt40"', word: "Color Label" },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/color/color_1_837f548.jpg" class="demo-1">',
        },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/color/color_2_6655e4f.jpg" class="demo-1 ml10">',
        },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/color/color_3_302df56.jpg" class="demo-1 ml10">',
        },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/color/color_4_5679322.jpg" class="demo-1 ml10">',
        },
        { type: "div", attr: 'class="clearfix"', word: "" },
        { type: "p", attr: 'class="title-2 mt40"', word: "Depth Image" },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/depth/depth_1_359ed89.jpg" class="demo-1">',
        },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/depth/depth_2_213db2e.jpg" class="demo-1 ml10">',
        },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/depth/depth_3_de93574.jpg" class="demo-1 ml10">',
        },
        {
            type: "div",
            attr: 'class="fl mt20 small-imgae"',
            word: '<img src="/public/img/scene/depth/depth_4_6c680be.jpg" class="demo-1 ml10">',
        },
        { type: "div", attr: 'class="clearfix"', word: "" },
        { type: "div", attr: 'class="cb"', word: "" },
        { type: "div", attr: 'class="cb"', word: "" },
        ...
        { type: "p", attr: 'class="title-2 mt40"', word: "Depth images" },
        // {
        //     'type': 'div',
        //     'attr': 'class="down_list mt20 clearfix" id="to_submit_href"',
        //     'word': [
        ...
        { type: "div", attr: 'class="cb"', word: "" },
        { type: "p", attr: 'class="title-2 mt40"', word: "Image lists" },
        { type: "div", attr: 'class="cb"', word: "" },
        {
            type: "p",
            attr: 'class="mt20 word-1"',
        ...
        { type: "p", attr: 'class="title-2 mt40"', word: "Depth image format:" },
        {
            type: "p",
            attr: 'class="word-1 mt10"',
  ...
  if ("en" == $.cookie("use_lang")) var t = e;
  else var t = e;
  return t;
}
function insert_html(e) {
  var t = "";
  $.each(e.banner, function (e, a) {
    (t += '<div class="main banner-inner tl">'),
      (t += '<p class="ban-title-one">' + a.title + "</p>"),
      (t += '<div class="ban-brief">'),
      $.each(a.brief, function (e, a) {
        t += "<p>" + a + "</p>";
      }),
      (t += "</div>"),
    ...
    (t += '<div class="menu fl">'),
    (t += "<ul>"),
    $.each(e.menu, function (e, a) {
      t +=
        '<li class="' + a.classes + '" id="' + a.id + '">' + a.word + "</li>";
    }),
    (t += "</ul>"),
    (t += "</div>"),
    (t += '<div class="content fl">'),
    $.each(e.content, function (e, a) {
      (t += "<" + a.type + " " + a.attr + ">"),
        "string" == typeof a.word
          ? (t += a.word)
          : $.each(a.word, function (e, a) {
              t += a;
            }),
        (t += "</" + a.type + ">");
    }),
    (t += "</div>"),
    (t += '<div class="cb"></div>'),
    $("#scene-container").html(t),
    (t = '<div class="content">'),
    $.each(e.protocol, function (e, a) {
      (t += "<" + a.type + " " + a.attr + ">"),
        "string" == typeof a.word
          ? (t += a.word)
          : $.each(a.word, function (e, a) {
...
function download(e) {
  ...
  $.get("/server/user/download", { downloadName: e, isAgree: t }, function (t) {
