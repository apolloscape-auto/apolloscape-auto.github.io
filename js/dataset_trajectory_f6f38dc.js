...
function get_arr() {
  var e = {
      ...
      menu: [
        { word: "1· Introduction", id: "to_data", classes: "menu-1 to_btn" },
        {
        ...
        { word: "8· Publication", id: "to_publicat", classes: "menu-1 to_btn" },
        { word: "9· Reference", id: "to_reference", classes: "menu-1 to_btn" },
      ],
      protocol: [
        {
          type: "div",
        ...
        { type: "div", attr: 'class="hr" id="download_id"', word: "" },
        {
          type: "a",
          attr: 'class="agree_btn agree_btn_no fl" value="0"',
          word: "I have read and agree to the Terms & Conditions above.",
        },
        { type: "a", attr: 'class="submit_btn fr"', word: "Confirm" },
      ],
    },
    t = e;
  if ("en" == $.cookie("use_lang")) var n = e;
  else var n = t;
  return n;
}
function insert_html(e) {
  var t = "";
  $.each(e.banner, function (e, n) {
    (t += '<div class="main banner-inner tl">'),
      (t += '<p class="ban-title-one">' + n.title + "</p>"),
      (t += '<div class="ban-brief">'),
      $.each(n.brief, function (e, n) {
        t += "<p>" + n + "</p>";
      }),
      (t += "</div>"),
      (t += '<p class="ban-brief-hr"  id="to_intro_href"></p>'),
      (t += "</div>");
  }),
    $("#banner-container").html(t),
    (t = ""),
    (t += "<ul>"),
    $.each(e.menu, function (e, n) {
      t +=
        '<li class="' + n.classes + '" id="' + n.id + '">' + n.word + "</li>";
    }),
    (t += "</ul>"),
    $("#scene-container .menu").html(t),
    (t = '<div class="content">'),
    $.each(e.protocol, function (e, n) {
      (t += "<" + n.type + " " + n.attr + ">"),
        "string" == typeof n.word
          ? (t += n.word)
          : $.each(n.word, function (e, n) {
              t += n;
            }),
        (t += "</" + n.type + ">");
    }),
    (t += "</div>"),
    $("#protocol_container").html(t);
}
function bind_function() {
  $(".submit_achievement").bind("click", function () {
    ...
    $(".to_btn").bind("click", function () {
      var e = $(this).attr("id");
      (location.href = "#" + e + "_href"), window.scrollBy(0, -150);
    }),
    ...
    $(".agree_btn").bind("mouseover", function () {
      "1" != $(this).attr("value") &&
        ($(this).removeClass("agree_btn_no"), $(this).addClass("agree_btn_on"));
    }),
    ...
    $(".submit_btn").bind("click", function () {
      var e = $("#download_id").attr("value");
      "1" != $(".agree_btn").attr("value")
...
function download(e) {
  var t = $(".agree_btn").attr("value");
  _hmt.push(["_trackEvent", "/trajectory", "download", e]),
    $.get(
      "/server/user/download",
      { downloadName: e, isAgree: t },
      function (t) {
        400 === t.status && (window.location = "/login.html"),
          401 === t.status && (window.location = "/info.html"),
          402 === t.status &&
            ($(".protocol-bg").css("display", "inline"),
            $(".protocol_container").css("display", "inline"),
            $("#download_id").attr("value", e)),
          0 === t.status && (window.location = t.data.url);
      }
    );
}
function isLogin(e) {
...
$(document).ready(function () {
  ...
  $.getJSON("/server/eccv/leaderboard/?taskId=trajectory", function (e) {
    var t = e.data.trajectory;
    $.each(t, function (e, t) {
      if (t.result)
        var n = $.parseJSON(t.result),
          o = n.score;
      var r = '<div class="rank-tr" id="car-' + e + '">';
      if ("3" === t.status)
        var i =
          '<div class="rank-td rank-td-lane">' +
          t.rank +
          '</div><div class="rank-td rank-td-lane">' +
          t.method_name +
          '</div><div class="rank-td rank-td-lane">' +
          o +
          '</div><div class="rank-td rank-td-lane">' +
      ...
      if ("0" === t.status || "2" === t.status)
        var i =
          '<div class="rank-td rank-td-lane">-</div><div class="rank-td rank-td-lane">' +
          t.method_name +
          '</div><div class="rank-td rank-td-lane">-</div><div class="rank-td rank-td-lane">' +
          t.created_at +
          '</div><div class="rank-td rank-td-lane">' +
          t.team_name +
          "</div>";
      if ("1" === t.status)
        var i =
          '<div class="rank-td rank-td-lane fail-text">fail</div><div class="rank-td rank-td-lane">' +
          t.method_name +
          '</div><div class="rank-td rank-td-lane fail-text">fail</div><div class="rank-td rank-td-lane">' +
          t.created_at +
          '</div><div class="rank-td rank-td-lane">' +
          t.team_name +
          "</div>";
